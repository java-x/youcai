...
public class FrontUserAction extends BaseAction implements SessionAware {
	...
	public String checkName() throws Exception {
		...
		json.put("msg", msg);
		json.put("haodai", "好贷网");
		json.put("all", json.toString());
		List<Map<String, Object>> list = new ArrayList<Map<String, Object>>();
		Map<String, Object> m = new HashMap<String, Object>();
		m.put("city", "北京");
		m.put("pinyin", "Beijing");
		list.add(m);
		m.put("city", "上海");
		m.put("pinyin", "Shanghai");
		list.add(m);
		m.put("city", "广州");
		m.put("pinyin", "Guangzhou");
		list.add(m);
		m.put("city", "深圳");
		m.put("pinyin", "Shenzhen");
		list.add(m);
		json.put("list", Arrays.toString(list.toArray()));
